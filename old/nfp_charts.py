#!/usr/bin/env python3
"""Generate NFP scenario charts from shared minute market data."""
...
from market_data import DEFAULT_MARKET_BARS_DB, DEFAULT_PAIRS, date_range, load_cached_day
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate NFP scenario charts from shared minute market data")
...
def main() -> None:
    ...
    print("=" * 80)
    print("NFP SCENARIO CHARTS (shared market data)")
    print("=" * 80)
